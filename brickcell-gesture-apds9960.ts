// https://github.com/limaodong118/pxt-zjwl-apds9960/
...
namespace Brickcell {
     ...
     */
    //% blockId=grove_gesture_read
    //% block="%apds9960|get gesture"
    //% subcategory="gesture apds9960"
    export function read(): number {
        ...
        switch (readGesture()) {
            ...
            case DIR.DIR_UP:
                //serial.writeLine("gesture: " + "UP");
                result = BrickcellGesture.Up;
                break;
            case DIR.DIR_DOWN:
                //serial.writeLine("gesture: " + "DOWN");
                result = BrickcellGesture.Down;
                break;
            case DIR.DIR_LEFT:
                //serial.writeLine("gesture: " + "LEFT");
                result = BrickcellGesture.Left;
                break;
            case DIR.DIR_RIGHT:
                //serial.writeLine("gesture: " + "RIGHT");
                result = BrickcellGesture.Right;
                break;
            default:
